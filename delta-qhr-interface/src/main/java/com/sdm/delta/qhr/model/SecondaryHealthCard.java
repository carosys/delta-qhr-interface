...
public class SecondaryHealthCard implements Serializable
{
    ...
    private final static long serialVersionUID = 6060528738512676240L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SecondaryHealthCard) == false) {
            return false;
        }
        SecondaryHealthCard rhs = ((SecondaryHealthCard) other);
